...
<html>
<head>
    <title>Social Media Website Installer</title>
...
<body>
	...
	<h1 class="animated fadeInDown"><i class="fa fa-download"></i>Social Media Website Installer</h1>
		...
		<?php
			...
			function run_checks($writable_files){
				...
				if( ini_get('allow_url_fopen') ) {
					echo '<p>allow_url_fopen is enable<i class="fa fa-check-circle-o"></i></p>'; // will do an action
				}else{
					echo '<p>allow_url_fopen is disabled<i class="fa fa-times-circle-o"></i></p>'; // will do another action
					$passed = false;
				}
				new_line();

				if (extension_loaded("fileinfo")) {
		    		echo '<p>php_fileinfo.dll is enable<i class="fa fa-check-circle-o"></i></p>'; // will do an action
				}else{
					echo '<p>php_fileinfo.dll is disabled<i class="fa fa-times-circle-o"></i></p>'; // will do another action
					$passed = false;
				}
				new_line();
